                ...
                <div className="flex items-center gap-4">
                  ...
                  {showRank && (
                    <div className="flex-shrink-0 w-8">
                      {index < 3 && RankIcon ? (
                        <div className={`p-1.5 rounded-full ${rankIcons[index].bg}`}>
                          <RankIcon className={`h-4 w-4 ${rankIcons[index].color}`} />
                        </div>
                      ) : (
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {showTrend && entry.trend !== undefined && (
                  <TrendIndicator value={entry.trend} size="sm" showValue={false} />
                )}
