import { Building2, Calendar, Clock, DollarSign, User } from "lucide-react";
...
export function DealCard({
	...
	if (compact) {
		return (
			// biome-ignore lint/a11y/noStaticElementInteractions: Interactive when onClick provided
			<div
				className={`
		...
		>
			...
			<div className="px-5 py-4 border-b border-gray-100">
				<div className="flex items-start justify-between gap-3">
					...
					<Badge variant={stageVariants[stage]}>{stageLabels[stage]}</Badge>
				</div>
			</div>
