		...
		return (
			<div className={`${className}`} {...props}>
				<div className="flex items-center justify-between mb-1">
					...
					<span
						className={`text-sm font-semibold ${isOverTarget ? "text-[#5dcb8a]" : "text-gray-900"}`}
					>
		...
		return (
			...
			>
				...
				<div className="flex items-start justify-between mb-4">
					...
					<div
						className={`p-2 rounded-lg ${isOverTarget ? "bg-rattle-green-lightest" : "bg-gray-100"}`}
					>
						{icon ||
							(isOverTarget ? (
              ...
              `}
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-1">
						<TrendingUp
							className={`h-4 w-4 ${isOverTarget ? "text-[#5dcb8a]" : "text-gray-400"}`}
						/>
						<span
							className={`text-sm font-semibold ${isOverTarget ? "text-[#5dcb8a]" : "text-gray-900"}`}
						>
