...
export const mockDeals: Deal[] = [
	{
		...
		notes:
			"Client is interested in enterprise features and has budget approved. Currently reviewing pricing options and contract terms. Decision maker is the CTO who is very engaged.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Fast-growing startup looking to scale. They need a solution that can grow with them. Currently evaluating multiple vendors.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Successfully closed! Multi-year enterprise contract signed. Client is very happy with the solution and implementation timeline.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Early-stage startup with limited budget. They are evaluating if our solution fits their needs. Need to demonstrate clear ROI.",
		nextSteps: [
			"Send ROI calculator",
	...
	},
	{
		...
		notes:
			"Large enterprise deal with multiple stakeholders. Procurement process is underway. High probability of closing. All technical requirements met.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Small business owner exploring options. Still in early stages of evaluation. Need to nurture and provide value before they are ready to commit.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Mid-market company looking to modernize their data infrastructure. Strong technical fit and budget confirmed. Decision timeline is aggressive.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Existing customer looking to expand their usage. High renewal probability. Upsell opportunity for additional modules.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Tech startup in growth phase. They need a solution that scales with their team. Currently evaluating pricing options.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Financial services company requiring compliance features. They have specific regulatory requirements that need to be addressed.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Large retail chain with multiple locations. They need a solution that works across all stores. Procurement process is standard.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Venture-backed startup with aggressive growth plans. They are evaluating multiple solutions and price is a factor.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Manufacturing company looking to digitize operations. They have specific integration requirements with their ERP system.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Creative agency exploring collaboration tools. Early stage conversation. Need to demonstrate value before budget approval.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Healthcare technology company with HIPAA compliance requirements. Security review completed successfully. Contract terms being finalized.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Logistics company looking to optimize operations. They have specific workflow requirements and need custom configuration.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Major financial technology company. Large enterprise deal with executive sponsorship. All approvals in place, finalizing terms.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Education technology company. They are evaluating solutions for the upcoming school year. Budget cycle is important.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Media production company with distributed teams. They need collaboration features and content management capabilities.",
		nextSteps: [
	...
	},
	{
		...
		notes:
			"Local service business exploring digital transformation. Early stage, needs education on value proposition.",
		nextSteps: [
			"Send ROI calculator",
...
export const mockAlerts: Alert[] = [
	...
	},
	{
		...
		description:
			"Acme Corp - Enterprise License has been in negotiation for 14 days",
		dealName: "Enterprise License",
		timestamp: "6 hours ago",
		priority: "high",
	},
	...
	mockDeals.slice(0, 8).forEach((deal, index) => {
		if (deal.recentActivity?.[0]) {
			...
			if (
				...
				activity.action.toLowerCase().includes("sent")
			) {
				type = "email";
			} else if (activity.action.toLowerCase().includes("meeting")) {
				type = "meeting";
			} else if (
				activity.action.toLowerCase().includes("stage") ||
				activity.action.toLowerCase().includes("moved")
			) {
				type = "stage-change";
			}
...
export const featuredDeal =
	mockDeals.find((d) => d.stage === "negotiation" && d.probability >= 80) ||
	mockDeals[4];
...
export const ownerOptions = [...new Set(mockDeals.map((d) => d.owner))].map(
	(owner) => ({
		value: owner,
		label: owner,
	}),
