	...
	const sampleActivities = [
		{
			...
			description: "$125,000 enterprise deal",
		...
		},
		{
			...
			description: "TechStart Inc moved forward",
		...
		},
		{
			...
			type: "email" as const,
			title: "Proposal sent",
			description: "Custom pricing proposal delivered",
			timestamp: "1 day ago",
			user: { name: "David Kim" },
		},
	];
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<div className="mb-12">
					...
					<p className="text-lg text-gray-600">
						A comprehensive collection of UI components built with Go Rattle's
						design system
					</p>
				</div>
				...
				{/* ===== CORE COMPONENTS ===== */}
				{/* biome-ignore lint/correctness/useUniqueElementIds: Single-use page section anchor */}
				<div id="core" className="mb-16">
					...
					<section className="mb-12">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<Card>
								<Text color="muted">
									Simple card with content. Cards provide a flexible container
					...
					<section className="mb-12">
						...
						<div className="space-y-4">
							<Alert
								...
								description="Acme Corp - Enterprise License ($125,000)"
							/>
							<Alert
								variant="warning"
								title="Deal at risk"
							...
							<Alert
								...
								description="Decision date is required"
							/>
							<Alert
								variant="info"
								title="New update available"
								description="Pipeline sync completed"
							/>
							<Alert
								variant="at-risk"
						...
						<Card>
							<Table>
								...
								<TableBody>
									<TableRow clickable>
										<TableCell>
											<Text weight="medium">Enterprise License</Text>
										</TableCell>
										<TableCell>
											<Text color="muted">Acme Corp</Text>
										</TableCell>
										<TableCell>
											<Text weight="semibold">$125,000</Text>
										</TableCell>
										<TableCell>
									...
									<TableRow clickable>
										<TableCell>
											<Text weight="medium">Platform Upgrade</Text>
										</TableCell>
										<TableCell>
											<Text color="muted">TechStart Inc</Text>
										</TableCell>
										<TableCell>
											<Text weight="semibold">$85,000</Text>
										</TableCell>
										<TableCell>
											<Badge variant="info">Proposal</Badge>
										</TableCell>
										<TableCell>
											<div className="flex items-center gap-2">
						...
						<Card className="p-6">
							<Tabs defaultValue="overview">
								<TabList variant="underline">
									...
									<TabTrigger value="analytics" variant="underline">
										Analytics
									</TabTrigger>
									<TabTrigger value="reports" variant="underline">
										Reports
									</TabTrigger>
									<TabTrigger value="settings" variant="underline" disabled>
										Settings
									</TabTrigger>
								</TabList>
								<TabContent value="overview">
									<Text color="muted">
										Overview content goes here. This tab shows a summary of your
										pipeline.
									</Text>
								</TabContent>
								<TabContent value="analytics">
									<Text color="muted">
										Analytics content goes here. Deep dive into your sales
										metrics.
									</Text>
								</TabContent>
								<TabContent value="reports">
									<Text color="muted">
										Reports content goes here. Export and schedule reports.
									</Text>
								</TabContent>
							</Tabs>
							...
							<Tabs defaultValue="all">
								<TabList variant="pills">
									...
									<TabTrigger value="open" variant="pills">
										Open
									</TabTrigger>
									<TabTrigger value="won" variant="pills">
										Won
									</TabTrigger>
									<TabTrigger value="lost" variant="pills">
										Lost
									</TabTrigger>
								</TabList>
							</Tabs>
